...
def process_image_request(
    ...
    try:
        ...
        from backend.core.config.comfyui_config import get_server_url
        ...
        from backend.core.config.comfyui_config import (
            get_all_generation_defaults,
            get_base_positive_prompt,
        )
