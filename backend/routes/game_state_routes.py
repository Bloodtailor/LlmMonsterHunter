...
def add_following_monster():
    ...
    result = game_state_service.add_following_monster(monster_id=data.get('monster_id'))
...
def remove_following_monster():
    ...
    result = game_state_service.remove_following_monster(monster_id=data.get('monster_id'))
...
def set_active_party():
    ...
    result = game_state_service.set_active_party(monster_ids=data.get('monster_ids', []))
