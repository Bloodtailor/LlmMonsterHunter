...
- [Settings](settings.md) — the in-game settings panel's backend: LLM provider config (local vs DeepSeek) and the Gemini image painter, stored in the one table that survives New Game
