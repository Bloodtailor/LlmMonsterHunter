...
DRY_RUN_SCENARIOS = {
    ...
    'check_cuda_path_env': [
        (
            True,
            "CUDA_PATH environment variable: C:\\Program Files\\NVIDIA GPU Computing Toolkit\\CUDA\\v12.2",
        ),
    ...
    'check_visual_studio_installations': [
        ...
        (
            True,
            "VS Build Tools 2022 found at C:\\Program Files (x86)\\Microsoft Visual Studio\\2022\\BuildTools",
        ),
...
def set_dry_run(check_name):
    ...
    fallback_choices = [
        (True, "Dry run error message not configured"),
        (False, "Dry run error message not configured"),
    ]
