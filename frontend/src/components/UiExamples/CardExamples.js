    ...
    return (
      <Card {...cardProps}>
        ...
        {cardBuilder.hasContent && (
          ...
          >
            <p style={{ margin: 0, color: 'var(--color-text-secondary)' }}>
              This is the card content area. It can contain any React elements, text, components, or
              complex layouts. The content automatically adapts to the card's size and padding
              settings.
            </p>
          </CardSection>
        )}
        ...
        {cardBuilder.hasFooter && (
          <CardSection type="footer" alignment={cardBuilder.alignment}>
      ...
      <CardSection type="content" title="Basic Cards">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              {Object.values(CARD_VARIANTS).map((variant) => (
                <Card key={variant} variant={variant} padding="md">
                  <CardSection type="content" alignment="center">
                    ...
                    <p
                      style={{ margin: 0, fontSize: '14px', color: 'var(--color-text-secondary)' }}
                    >
          ...
          <div>
            ...
            >
              <Card interactive onClick={() => alert('Interactive card clicked!')} padding="md">
                <CardSection type="content" alignment="center">
                  <h5 style={{ margin: '0 0 8px 0', color: 'var(--color-text-primary)' }}>
                    Clickable Card
                  </h5>
          ...
          <div>
            ...
            <Card variant="outlined" padding="none">
              ...
              <CardSection type="content">
                <p style={{ margin: 0, color: 'var(--color-text-secondary)' }}>
                  This is a content section without a title. Multiple content sections can be used
                  to organize information within a card.
                </p>
              </CardSection>
          ...
          <CardSection type="content">
            <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  A mighty dragon with flames that can melt steel. Known for its fierce loyalty and
                  protective nature when bonded with a trainer.
                </p>
      ...
      <CardSection type="content" title="Interactive Card Builder">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            ...
            <div style={{ maxWidth: '400px', margin: '0 auto' }}>{renderBuilderCard()}</div>
          </div>
            ...
            <FormField label="Content Title">
              <Select
                ...
                onChange={(e) =>
                  handleBuilderChange(
                    'contentTitle',
                    e.target.value === 'true' ? 'Content Section' : '',
                  )
                }
                options={[
