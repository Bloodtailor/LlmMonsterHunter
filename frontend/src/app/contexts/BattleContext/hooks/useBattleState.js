...
export function useBattleState() {
  ...
  const [chronicle, setChronicle] = useState(null); // the run's chronicle entry (defeat ends the run)
  const [runNumber, setRunNumber] = useState(null); // which run the chronicle stamps
